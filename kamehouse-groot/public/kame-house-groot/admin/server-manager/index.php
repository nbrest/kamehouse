<?php require_once(realpath($_SERVER["DOCUMENT_ROOT"]) . "/kame-house-groot/api/v1/auth/authorize-page.php") ?>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<body>
      ...
      <div class="info-image-wrapper-m-80-40">
        <table class="info-image-table">
          ...
          <tbody>
            <tr>
              <td class="info-image-img">
                <img src="/kame-house/img/dbz/majin-vegeta.jpg" alt="info image"/>
              </td>
              <td class="info-image-info">
                <div class="info-image-title info-image-title-bottom">
                  Still can't deploy?
                ...
                <div class="info-image-desc">
                  <p>The file system might be corrupted like majin Vegeta. Double check that it's still healthy</p>
                </div>
              </td>
            </tr>
          </tbody>
          ...
          <tbody>
            <tr>
              ...
              <td>
                ...
                <div class="link-image-desc">
                  Check if the file system is in a healthy state for a deployment or if it switched to read only.
                </div>
              </td>
            </tr>
          </tbody>
  ...
  <div class="txt-c-d-kh m-20-d-kh">
    <a><img class="img-btn-kh server-manager-batcave" src="/kame-house/img/dc/batman-1989-black.png" alt="Batcave" onclick="kameHouse.util.mobile.windowOpen('/kame-house-batcave/index.html', '_self')"/></a>
  </div>
