...
class KameHouseMobileTabsManager {
   ...
   */
  load() {
    kameHouse.util.dom.load(document.getElementById("kh-mobile-tabs-wrapper"), "/kame-house-mobile/kamehouse-mobile/plugin/html/kamehouse-mobile-settings-tabs.html", () => {
      kameHouse.util.module.setModuleLoaded("mobileTabsManager");
    });
    kameHouse.util.dom.load(document.getElementById("tab-backend"), "/kame-house-mobile/kamehouse-mobile/plugin/html/tab-backend.html", () => {
