...
if [ -z "$STY" ]; then
  PS1=${PS1_PREFIX}${PS1_USERNAME}${PS1_AT}${PS1_HOSTNAME}${PS1_DOT}${PS1_PWD}${PS1_GIT}${PS1_SUFFIX}  
else
  PS1=${PS1_PREFIX}${PS1_SCREEN}${PS1_USERNAME}${PS1_AT}${PS1_HOSTNAME}${PS1_DOT}${PS1_PWD}${PS1_GIT}${PS1_SUFFIX}
fi
