...
main() {
  ...
  gitCloneKameHouse
  sudo /bin/bash -c 'cd /root/git/kamehouse ; chmod a+x kamehouse-shell/bin/shell/install-kamehouse-shell.sh'
  sudo /bin/bash -c 'cd /root/git/kamehouse ; ./kamehouse-shell/bin/shell/install-kamehouse-shell.sh'
