...
source ${HOME}/programs/kamehouse-shell/bin/common/functions/audio-playlists/upload-to-android-functions.sh
if [ "$?" != "0" ]; then
...
ANDROID_PLAYLISTS_PATH=${HOME}/git/kamehouse-audio-playlists/playlists/android-external
