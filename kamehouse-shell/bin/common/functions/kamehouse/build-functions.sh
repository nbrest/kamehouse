...
buildMavenCommand() {
  ...
  MAVEN_COMMAND="${MAVEN_COMMAND} -Dfilter.kamehouse-server.mac=${KAMEHOUSE_SERVER_MAC} "
  MAVEN_COMMAND="${MAVEN_COMMAND} -Dfilter.kamehouse-server.broadcast=${KAMEHOUSE_SERVER_BROADCAST} "
