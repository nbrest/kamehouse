...
exportMariadbDataOnDocker() {
  ...
  SSH_COMMAND="/home/${DOCKER_USERNAME}/programs/kamehouse-shell/bin/mariadb/mariadb-csv-kamehouse.sh"
  ...
  SSH_USER="${DOCKER_USERNAME}"
  SSH_SERVER="localhost"
  SSH_COMMAND="/home/${DOCKER_USERNAME}/programs/kamehouse-shell/bin/mariadb/mariadb-dump-kamehouse.sh"
  IS_REMOTE_LINUX_HOST=true
  executeSshCommand --skip-exit-code-check
}
