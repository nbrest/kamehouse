...
updateUsername() {
  ...
  sed -i "s#KAMEHOUSE_USER#${USERNAME}#g" "${KAMEHOUSE_SHELL_PATH}/bin/pi/startup/rc-local.service"
}
...
generateKameHouseShellPathFile() {
  ...
  local KAMEHOUSE_SHELL_WIN_PATH=`getPathWithSubdirectories "${HOME}/programs/kamehouse-shell/bin" "/lin\|/pi\|/kamehouse/docker/release/java8-release/bin\|/kamehouse/docker/release/java11-release/bin\|/kamehouse/docker/release/java8-release/docker\|/kamehouse/docker/release/java11-release/docker"`
  echo "KAMEHOUSE_SHELL_WIN_PATH=${KAMEHOUSE_SHELL_WIN_PATH}" >> ${KAMEHOUSE_SHELL_PATH_FILE}

  local KAMEHOUSE_SHELL_LIN_PATH=`getPathWithSubdirectories "${HOME}/programs/kamehouse-shell/bin" "/win\|/kamehouse/docker/release/java8-release/bin\|/kamehouse/docker/release/java11-release/bin\|/kamehouse/docker/release/java8-release/docker\|/kamehouse/docker/release/java11-release/docker"`
