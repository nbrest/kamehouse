...
generateKameHouseShellPathFile() {
  ...
  local KAMEHOUSE_SHELL_WIN_PATH=`getPathWithSubdirectories "${HOME}/my.scripts" "/lin\|/pi"`
  KAMEHOUSE_SHELL_WIN_PATH=${KAMEHOUSE_SHELL_WIN_PATH}`getPathWithSubdirectories "${HOME}/programs/kamehouse-shell/bin" "/lin\|/pi"`
  echo "KAMEHOUSE_SHELL_WIN_PATH=${KAMEHOUSE_SHELL_WIN_PATH}" >> ${KAMEHOUSE_SHELL_PATH_FILE}

  local KAMEHOUSE_SHELL_LIN_PATH=`getPathWithSubdirectories "${HOME}/my.scripts" "/win"`
  KAMEHOUSE_SHELL_LIN_PATH=${KAMEHOUSE_SHELL_LIN_PATH}`getPathWithSubdirectories "${HOME}/programs/kamehouse-shell/bin" "/win"`
