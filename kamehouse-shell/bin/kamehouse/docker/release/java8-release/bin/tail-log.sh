...
main() {
  log.info "Tail log kamehouse java8-release"
  tail -n 2000 -f /home/${DOCKER_CONTAINER_USERNAME}/programs/apache-tomcat/logs/* /home/${DOCKER_CONTAINER_USERNAME}/programs/apache-httpd/logs/*
}
