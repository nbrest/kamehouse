...
SELECT * FROM booking_response where booking_request_id in (SELECT id FROM booking_request WHERE date < NOW() - INTERVAL 30 DAY);

DELETE FROM booking_response where booking_request_id in (SELECT id FROM booking_request WHERE date < NOW() - INTERVAL 30 DAY);
...
SELECT * FROM booking_request WHERE date < NOW() - INTERVAL 30 DAY;

DELETE FROM booking_request WHERE date < NOW() - INTERVAL 30 DAY;
