...
mainProcess() {
  ...
  sudo chmod 744 /home/${USERNAME}/programs/kamehouse-shell/bin/startup/kamehouse-startup-service.sh
  sudo cp -v /home/${USERNAME}/programs/kamehouse-shell/bin/startup/kamehouse-startup.service /etc/systemd/system/kamehouse-startup.service 
