...
public class DragonBallControllerTest
  ...
  @InjectMocks private DragonBallController dragonBallController;
  ...
  /**
   * Tests the rest web service on the endpoint /dragonball/users with the HTTP method GET. The
   * service should respond with HTTP status 200 OK and a json array in the response body.
   */
  @Test
