    ...
    <div class="default-layout">
          ...
          <tbody>
            <tr>
              <td class="info-image-img">
                <img src="/kame-house/img/saint-seiya/dohko-shion-previous-era.jpg" alt="info img"/>
              </td>
      ...
      <div class="link-image-wrapper-m-80-60 link-image-wrapper-w-80">
        ...
        <tbody>
            <tr>
              <td>
                <button class="link-image-img" data-background-img="/kame-house/img/dbz/scouter.png" onclick="kameHouse.core.windowLocation('/kame-house-testmodule/api/v1/testmodule/sample/dragonball/model-and-view?name=gohan')"></button>
              </td>
              <td>
