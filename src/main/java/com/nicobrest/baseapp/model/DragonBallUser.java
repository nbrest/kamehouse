...
public class DragonBallUser implements Serializable {
  ...
  private void validateUsernameFormat(String username) {
    ...
    if (!matcher.matches()) {
      throw new BaseAppInvalidDataException("Invalid username format: " + username);
    }
  }
  ...
  private void validateEmailFormat(String email) {
    ...
    if (!matcher.matches()) {
      throw new BaseAppInvalidDataException("Invalid email address: " + email);
    }
  }
  ...
  private void validatePositiveValue(int value) {
    ...
    if (value < 0) {
      throw new BaseAppInvalidDataException(
