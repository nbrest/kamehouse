package com.nicobrest.baseapp.controller;
...
import com.nicobrest.baseapp.controller.DragonBallController;
...
import com.nicobrest.baseapp.utils.JsonUtils;
...
public class DragonBallControllerTest {
  ...
  public void getUsersNotFoundExceptionTest() {
    ...
    try {
      mockMvc.perform(get("/api/v1/dragonball/users?action=BaseAppNotFoundException"))
  ...
  public void postUsersConflictExceptionTest() {
    ...
    try {
      // Setup mock object dragonBallUserServiceMock
      Mockito.doThrow(new BaseAppConflictException("User already exists"))
      ...
      if (!(e.getCause() instanceof BaseAppConflictException)) {
        e.printStackTrace();
        fail("Caught unexpected exception.");
      }
    }
  ...
  public void getUsersUsernameTest() {
    ...
    try {
      Mockito.reset(dragonBallUserServiceMock);
      Mockito.doThrow(new BaseAppNotFoundException("User trunks not found"))
      ...
      if (!(e.getCause() instanceof BaseAppNotFoundException)) {
        e.printStackTrace();
        fail("Caught unexpected exception.");
      }
    }
  ...
  public void putUsersUsernameNotFoundExceptionTest() {
    ...
    try {
      // Setup mock object dragonBallUserServiceMock
      Mockito.doThrow(new BaseAppNotFoundException("User not found"))
