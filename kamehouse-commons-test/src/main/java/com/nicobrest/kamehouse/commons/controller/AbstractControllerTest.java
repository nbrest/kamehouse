...
/**
 * Super class to all controller test classes to group common attributes and functionality to all
...
public abstract class AbstractControllerTest<E, D> {
   ...
   */
  protected static void verifyContentType(
      MockHttpServletResponse response, MediaType expectedContentType) {
