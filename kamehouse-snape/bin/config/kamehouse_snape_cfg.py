...
class KameHouseSnapeCfg():
    def __init__(self):
        home_dir = str(Path.home())
        config_files = [home_dir + '/programs/kamehouse-snape/conf/default-kamehouse-snape.cfg', home_dir + '/.kamehouse/config/kamehouse-snape.cfg']
...
kamehouse_snape_cfg = KameHouseSnapeCfg()