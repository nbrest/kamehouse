...
public class ExceptionHandlerConfig {
  ...
  public SimpleMappingExceptionResolver exceptionResolver() {
    ...
    exceptionMappings.setProperty("com.nicobrest.kamehouse.commons.exception"
        + ".KameHouseBadRequestException", "/error/400");
    exceptionMappings.setProperty("com.nicobrest.kamehouse.commons.exception"
        + ".KameHouseConflictException", "/error/409");
    exceptionMappings.setProperty("com.nicobrest.kamehouse.commons.exception"
        + ".KameHouseForbiddenException", "/error/403");
    exceptionMappings.setProperty("com.nicobrest.kamehouse.commons.exception"
        + ".KameHouseInvalidCommandException", "/error/400");
    exceptionMappings.setProperty("com.nicobrest.kamehouse.commons.exception"
        + ".KameHouseNotFoundException", "/error/404");
    exceptionMappings.setProperty("com.nicobrest.kamehouse.commons.exception"
        + ".KameHouseServerErrorException", "/error/500");
    exceptionMappings.setProperty("org.springframework.security.core.userdetails"
