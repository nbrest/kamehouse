...
mklink /D "%USERPROFILE%\programs\apache-httpd\www\www-eclipse\kame-house-groot" "%USERPROFILE%\workspace-eclipse\kamehouse\kamehouse-groot\dist\kame-house-groot"
