...
mklink /D "%USERPROFILE%\programs\apache-httpd\www\www-intellij\kame-house-groot" "%USERPROFILE%\workspace-intellij\kamehouse\kamehouse-groot\dist\kame-house-groot"
